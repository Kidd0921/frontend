const UserProfileButton = () => {
  return (
    <div>
      <button className="flex items-center px-2 py-2 border rounded-full text-teal-200 border-teal-400 hover:text-white hover:border-white">
        <svg 
